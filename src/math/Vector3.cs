...
namespace RayTracer
{
    ...
    public readonly struct Vector3
    {
        ...
        {
            // Write your code here...
            double output = Math.Sqrt(LengthSq());
            return output;
        }
        ...
        {
            // Write your code here...
            double output = (X * with.X) + (Y * with.Y) + (Z * with.Z);
            return output;
        }
        ...
        {
            // Write your code here...
            double newX = Y * with.Z - Z * with.Y;
            double newY = Z * with.X - X * with.Z;
            double newZ = X * with.Y - Y * with.X;
